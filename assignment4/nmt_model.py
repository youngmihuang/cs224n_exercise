...
Youngmi Huang <cyeninesky3@gmail.com>
"""
...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.decoder = nn.LSTMCell((embed_size + self.hidden_size), embed_size, bias=True)
        ...
        self.target_vocab_projection = nn.Linear(self.hidden_size, embed_size, bias=False)
